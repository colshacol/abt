...
class App extends _ink.default.Component {
  constructor(...args) {
    ...
    return _temp = super(...args), Object.defineProperty(this, "json", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: ''
  ...
  render(props, state, context) {
    return (0, _ink.h)("div", null, !state.gotJSON ? [(0, _ink.h)(_inkSpaces.BlankLines, {
      count: 2,
      key: "0"
      ...
      key: "2"
    }, "Getting the JSON.")] : state.gotJSON ? [(0, _ink.h)(_inkSpaces.BlankLines, {
      count: 2,
      key: "0"
    }), (0, _ink.h)(_ink.Text, {
      key: "1"
    }, "[\"", _consts.PACKAGE_JSON, "\"]", this.context.args._[0], " == "), (0, _ink.h)(_ink.Text, {
      key: "2"
    }, this.json)] : null);
  }
